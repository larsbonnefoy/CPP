...
//this->_garde will be an undefined value, set it to smtgh?
//catch it in the constructor or in the calling function?
...
Bureaucrat::~Bureaucrat(void) {
    std::cout << "Default destructor of " << this->getName() << " Called" << std::endl;
}
